...
def load_and_process_train_data(train_data, batch_size=64 , model_use_l = 0,model_use_r = 112):
    
    num_prompts = int(max(train_data["prompt_id"])) + 1

    model_ids = train_data["model_id"].unique()
    selected_model_ids = model_ids[model_use_l:model_use_r]
...
def load_and_process_test_data(test_data, batch_size=64 , model_use_l = 0,model_use_r = 112):
    
    num_prompts = int(max(test_data["prompt_id"])) + 1
